  ...
  return (
    <>
      ...
      <Container>
        ...
        <Modal open={openAddModal} style={{ overflowY: 'scroll', }} onClose={handleCloseAddModal}>
          <AddContainer>
            <IconButton style={{ position: 'absolute', left: 0, top: 0, margin: '0.83em' }}>
              <Close style={{ color: 'white' }} onClick={handleCloseAddModal} />
            </IconButton>
